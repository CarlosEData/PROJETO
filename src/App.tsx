    ...
    <nav className="fixed top-0 left-0 right-0 bg-black/95 backdrop-blur-sm border-b border-yellow-500/20 z-50">
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between h-16">
          <img 
            src="https://images.pexels.com/photos/5668772/pexels-photo-5668772.jpeg?auto=compress&cs=tinysrgb&w=120&h=40&fit=crop" 
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-black via-gray-900 to-black pt-16">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="mb-8">
            <img 
              src="https://images.pexels.com/photos/5668772/pexels-photo-5668772.jpeg?auto=compress&cs=tinysrgb&w=200&h=80&fit=crop" 
              alt="KW Advocacia Digital" 
      ...
      {showCPFModal && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-gray-900 rounded-lg border border-yellow-500/30 p-8 max-w-md w-full relative">
            <button
            ...
            {!showPlanDetails ? (
              <>
                <div className="text-center mb-8">
                  ...
                  <h3 className="text-2xl font-bold mb-2">Verificação de Acesso</h3>
                  <p className="text-gray-400">
                    Digite seu CPF para visualizar os valores do plano <span className="text-yellow-500">{selectedPlan}</span>
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-black border border-gray-700 rounded-lg text-white focus:border-yellow-500 focus:outline-none transition-colors"
                      maxLength={14}
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full bg-yellow-500 text-black py-3 rounded-lg font-semibold hover:bg-yellow-400 transition-all duration-300"
                  >
                    Consultar
                  </button>
                </div>
              ...
              <>
                <div className="text-center mb-8">
                  ...
                  <h3 className="text-2xl font-bold mb-2">Plano {selectedPlan}</h3>
                  <p className="text-gray-400">{planDetails[selectedPlan as keyof typeof planDetails]?.description}</p>
                </div>
                ...
                <div className="space-y-4">
                  <h4 className="font-semibold text-lg">Benefícios inclusos:</h4>
                ...
                <button
                  onClick={openWhatsApp}
                  className="w-full mt-6 bg-yellow-500 text-black py-3 rounded-lg font-semibold hover:bg-yellow-400 transition-all duration-300"
                >
                  Quero Este Plano
                </button>
              </>
